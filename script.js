...
// const option2Button = document.getElementById('option-2-button'); // Eliminado
...
        option1Button.textContent = `Opción 1: Cuty.io`; 
        // option2Button ya no existe, no se establece su texto.
...
        }
        ...
        // Bloque de código para option2Button eliminado
...
            currentProgress++; 
            localStorage.setItem('userCheckpointProgress', currentProgress.toString()); 
